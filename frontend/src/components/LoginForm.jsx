        ...
        {isRegister ? (
          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="form-group">
              ...
              <input id="login-username" name="username-login" value={username} onChange={e => setUsername(e.target.value)} required autoComplete="username" aria-describedby={error ? 'login-error' : undefined} />
            </div>
            <div className="form-group password-wrapper">
